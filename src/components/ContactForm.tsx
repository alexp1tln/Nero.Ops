    ...
    <div className="bg-white/[0.03] p-5 sm:p-8 mt-5 md:p-10 rounded-2xl sm:rounded-3xl border border-white/10 shadow-inner backdrop-blur-md w-full relative overflow-hidden">
      ...
      {!submitted ? (
        <motion.form 
          ...
          className="relative z-10 space-y-5 sm:space-y-6 w-full"
        >
          <div className="mb-6 sm:mb-8 text-left border-b border-white/10 pb-5 sm:pb-6">
            <h3 className="text-xl sm:text-2xl font-display font-semibold text-white mb-2">Обсудить проект</h3>
            <p className="text-white/50 font-light text-[13px] sm:text-sm">Оставьте контактные данные, руководитель направления свяжется с вами.</p>
          </div>
