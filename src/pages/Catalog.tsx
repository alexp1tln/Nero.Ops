...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    longDescription: 'Создание карточек товаров для ведущих маркетплейсов. Проектируем визуальную структуру карточки на основе исследования болей покупателей и алгоритмов ранжирования площадки.',
    price: 'ОТ 1 000 ₽ / арт.',
