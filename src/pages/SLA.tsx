    ...
    <div className="pt-48 pb-40 max-w-5xl mx-auto px-4 sm:px-6 w-full min-h-screen bg-transparent relative">
      ...
      <div className="glass-panel p-8 md:p-12 relative z-10 text-white/70 font-light leading-relaxed space-y-8">
        <section>
          ...
          <p>
            Nero.Ops гарантирует доступность развернутой инфраструктуры и интеграционных решений на уровне 99.9% в месяц. Запланированные технические работы (Scheduled Maintenance) проводятся в часы наименьшей нагрузки по московскому времени (с 02:00 до 05:00) с предварительным уведомлением за 48 часов.
          </p>
        </section>
