...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Абсолютно. Более 85% наших проектов находятся под строгим NDA. Вся информация остается строго внутри контура Nero.Ops, обеспечивая полную безопасность ваших данных."
    },
    {
