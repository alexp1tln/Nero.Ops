    ...
    <div className="pt-48 pb-40 max-w-5xl mx-auto px-4 sm:px-6 w-full min-h-screen bg-transparent relative">
      ...
      <div className="glass-panel p-8 md:p-12 relative z-10 text-white/70 font-light leading-relaxed space-y-8">
        <section>
          ...
          <p>
            Настоящая политика конфиденциальности описывает, как Nero.Ops (далее «Мы», «Компания») собирает, использует и защищает вашу личную информацию и корпоративные данные при использовании наших ИТ-услуг, консалтинга и автоматизации.
          </p>
          <p className="mt-4">
        ...
        <section>
          ...
          <p>
            Вся инфраструктура Nero.Ops развернута с использованием защищенных облачных хранилищ, соответствующих международным стандартам безопасности. Мы используем сквозное шифрование для обмена конфиденциальными ключами, API-токенами и коммерческой тайной клиентов.
          </p>
          <p className="mt-4">
